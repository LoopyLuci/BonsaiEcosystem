...
cargo run -p bonsai-mcp-server -- headless --fallback-terminal

# HITL with verbose logging
cargo run -p bonsai-mcp-server -- headless --verbose --fallback-terminal

# Custom categories
cargo run -p bonsai-mcp-server -- headless --hitl-categories destructive,model

# Disable HITL
cargo run -p bonsai-mcp-server -- headless --no-hitl

# Quiet mode (no console output, only notifications)
cargo run -p bonsai-mcp-server -- headless --quiet --fallback-terminal
```
...
```bash
cargo run -p bonsai-mcp-server -- headless --no-hitl --quiet
```
...
**Headless:**
```bash
cargo run -p bonsai-mcp-server -- headless --hitl-categories destructive --fallback-terminal
```
...
**Headless:**
```bash
cargo run -p bonsai-mcp-server -- headless --hitl-categories all --fallback-terminal
```
...
cargo run -p bonsai-mcp-server -- visual --hitl-categories destructive,network,model
