...
**Date:** 2026-06-02  
**Integration:** MCP Protocol via bonsai-mcp-server
...
The Bug Hunter is integrated at these points in bonsai-mcp-server:
...
```json
{
  ...
  "command": "cargo",
  "args": ["run", "--package", "bonsai-mcp-server", "--release"],
  "env": {
