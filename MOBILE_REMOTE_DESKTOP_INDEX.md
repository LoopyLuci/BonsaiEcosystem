...
3. **Source Code**:
   - Session Management: `crates/bonsai-mcp-server/src/mobile_session.rs`
   - Terminal Commands: `crates/bonsai-mcp-server/src/bti_commands.rs`
   - Integration Tests: `crates/bonsai-mcp-server/tests/integration_tests.rs`
...
#### `crates/bonsai-mcp-server/src/tools.rs` (modified)
...
#### `crates/bonsai-mcp-server/src/lib.rs` (modified)
**Purpose**: Module declarations
**Changes**:
- Added `pub mod mobile_session`
- Added `pub mod bti_commands`

#### `crates/bonsai-mcp-server/src/uacs.rs` (modified)
...
2. Review: `crates/bonsai-mcp-server/src/mobile_session.rs`
3. Check: `crates/bonsai-mcp-server/tests/integration_tests.rs`
4. Implement: Your feature/fix
5. Test: `cargo test -p bonsai-mcp-server`
...
cargo test -p bonsai-mcp-server --lib bti_commands
```
...
Code Examples?
  ...
  → crates/bonsai-mcp-server/tests/integration_tests.rs
```
