...
### 4. MCP Tools
- [x] **Modified File**: `crates/bonsai-mcp-server/src/tools.rs`
...
All tools registered in `crates/bonsai-mcp-server/src/tools.rs`:
...
- [x] `crates/bonsai-mcp-server/src/tools.rs` (+100 lines)
