...
#### BonsaiTdlClient.kt
- **Location**: `android-runtime/app/src/main/java/ai/bonsai/buddy/data/tdl/`
- **Lines**: 350+
- **Classes**:
...
#### BonsaiKdbClient.kt
- **Location**: `android-runtime/app/src/main/java/ai/bonsai/buddy/data/kdb/`
- **Lines**: 380+
- **Classes**:
...
- **Android**: `android-runtime/app/src/main/java/ai/bonsai/buddy/data/{tdl,kdb}/`
...
13. ✓ android-runtime/.../tdl/BonsaiTdlClient.kt
14. ✓ android-runtime/.../kdb/BonsaiKdbClient.kt
