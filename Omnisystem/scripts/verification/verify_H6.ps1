# verify_H6.ps1 — Phase H6: Chat UI & Mascot
...
$modules = @("titan/omnibot/h6_chat.ti", "tests/test_h6.ti")
$regression = @("titan/omnibot/h5_tools.ti", "titan/omnibot/h4_router.ti")
$failed = 0
Write-Host "`n=== Phase H6: Chat UI & Mascot ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase H6 complete [score: 111]" -ForegroundColor Green; exit 0 }
