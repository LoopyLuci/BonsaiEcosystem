# verify_R6.ps1 — Phase R6: Security & Multi-Tenant
...
$failed = 0
Write-Host "`n=== Phase R6: Security & Multi-Tenant ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) {
    Write-Host "RESULT: ALL $total VERIFIED — Phase R6 complete [score: 111]" -ForegroundColor Green
    exit 0
} else {
