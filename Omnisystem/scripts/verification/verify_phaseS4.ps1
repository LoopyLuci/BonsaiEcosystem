# verify_phaseS4.ps1 — Phase S4: OmniSplat: Selection System
...
$failed = 0
Write-Host "`n=== Phase S4: OmniSplat: Selection System ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) {
    Write-Host "RESULT: ALL $total VERIFIED — Phase S4 complete [score: 111]" -ForegroundColor Green
    exit 0
} else {
