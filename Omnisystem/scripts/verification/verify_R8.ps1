# verify_R8.ps1 — Phase R8: Axiom Verification & Stress Testing
...
$failed = 0
Write-Host "`n=== Phase R8: Axiom Verification & Stress Testing ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) {
    Write-Host "RESULT: ALL $total VERIFIED — Phase R8 complete [score: 111]" -ForegroundColor Green
    exit 0
} else {
