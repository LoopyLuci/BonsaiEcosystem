# verify_phase5_audio.ps1 — Phase 5: Win32 Beep audio synthesis
...
$regression = @(
    "titan/axlib/ax5_crypto.ti",
    "titan/omnilib/omniThread.ti"
)

$failed = 0
Write-Host "`n=== Phase 5: Win32 Beep Audio Synthesis ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED - Phase 5 complete [score: 111]" -ForegroundColor Green; exit 0 }
