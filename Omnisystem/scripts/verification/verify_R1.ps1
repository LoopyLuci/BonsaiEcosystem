# verify_R1.ps1 — Phase R1: Core Router & Format Translation
...
$failed = 0
Write-Host "`n=== Phase R1: Core Router & Format Translation ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) {
    Write-Host "RESULT: ALL $total VERIFIED — Phase R1 complete [score: 111]" -ForegroundColor Green
    exit 0
} else {
