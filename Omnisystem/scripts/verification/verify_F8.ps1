# verify_F8.ps1 — Phase F8: Multiplayer & Networking
...
$modules = @("titan/omnidesign/f8_net.ti", "tests/test_f8.ti")
$regression = @("titan/omnidesign/f7_audio.ti", "titan/omnidesign/f6_anim.ti")
$failed = 0
Write-Host "`n=== Phase F8: Multiplayer & Networking ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase F8 complete [score: 111]" -ForegroundColor Green; exit 0 }
