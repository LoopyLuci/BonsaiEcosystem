# verify_G3.ps1 — Phase G3: OmniSplat IDE Panel
...
$modules = @(
    "titan/omnirender/g3_idepanel.ti",
    "tests/test_g3.ti"
)
$regression = @(
    "titan/omnirender/g2_browser3d.ti",
    "titan/omnirender/g1_shader.ti"
)
$failed = 0
Write-Host "`n=== Phase G3: OmniSplat IDE Panel ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) {
    Write-Host "RESULT: ALL $total VERIFIED — Phase G3 complete [score: 111]" -ForegroundColor Green
    exit 0
} else {
