# verify_H7.ps1 — Phase H7: Learning Loop
...
$modules = @("titan/omnibot/h7_learn.ti", "tests/test_h7.ti")
$regression = @("titan/omnibot/h6_chat.ti", "titan/omnibot/h5_tools.ti")
$failed = 0
Write-Host "`n=== Phase H7: Learning Loop ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase H7 complete [score: 111]" -ForegroundColor Green; exit 0 }
