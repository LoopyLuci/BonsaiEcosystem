# verify_C4.ps1 — Phase C4: Anti-Fingerprinting & Privacy
...
$modules = @("titan/omnicloak/c4_antifp.ti", "tests/test_c4.ti")
$regression = @("titan/omnicloak/c3_cloak.ti", "titan/omnicloak/c2_dht.ti")
$failed = 0
Write-Host "`n=== Phase C4: Anti-Fingerprinting & Privacy ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase C4 complete [score: 111]" -ForegroundColor Green; exit 0 }
