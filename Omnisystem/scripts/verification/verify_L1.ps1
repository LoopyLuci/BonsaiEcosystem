# verify_L1.ps1 — Phase L1: Advanced Networking
...
$modules = @("titan/omnilib/l1_net.ti", "tests/test_l1.ti")
$regression = @("titan/omnidesign/f15_bench.ti", "titan/omnidesign/f14_verify.ti")
$failed = 0
Write-Host "`n=== Phase L1: Advanced Networking ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase L1 complete [score: 111]" -ForegroundColor Green; exit 0 }
