# verify_G6.ps1 — Phase G6: Performance & Streaming
...
$failed = 0
Write-Host "`n=== Phase G6: Performance & Streaming ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) {
    Write-Host "RESULT: ALL $total VERIFIED — Phase G6 complete [score: 111]" -ForegroundColor Green
    exit 0
} else {
