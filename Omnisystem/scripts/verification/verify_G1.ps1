# verify_G1.ps1 — Phase G1: OmniRender Foundation
...
$failed = 0
Write-Host "`n=== Phase G1: OmniRender Foundation ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) {
    Write-Host "RESULT: ALL $total VERIFIED — Phase G1 complete [score: 111]" -ForegroundColor Green
    exit 0
} else {
