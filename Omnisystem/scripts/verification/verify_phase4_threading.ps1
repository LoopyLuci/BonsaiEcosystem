# verify_phase4_threading.ps1 — Phase 4: Win32 mutex + threading
...
$regression = @(
    "titan/axlib/ax4_conc.ti",
    "titan/omnilib/omniNet.ti"
)

$failed = 0
Write-Host "`n=== Phase 4: Win32 Mutex + Threading ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED - Phase 4 complete [score: 111]" -ForegroundColor Green; exit 0 }
