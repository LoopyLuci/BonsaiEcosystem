# verify_C2.ps1 — Phase C2: Decentralised P2P Network
...
$modules = @("titan/omnicloak/c2_dht.ti", "tests/test_c2.ti")
$regression = @("titan/omnicloak/c1_circuit.ti", "titan/omnirouter/r9_agent.ti")
$failed = 0
Write-Host "`n=== Phase C2: Decentralised P2P Network ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase C2 complete [score: 111]" -ForegroundColor Green; exit 0 }
