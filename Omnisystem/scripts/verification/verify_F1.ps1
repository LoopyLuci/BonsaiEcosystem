# verify_F1.ps1 — Phase F1: Unified Geometry Kernel
...
$modules = @("titan/omnidesign/f1_kernel.ti", "tests/test_f1.ti")
$regression = @("titan/omnibot/h9_ide.ti", "titan/omnibot/h8_verify.ti")
$failed = 0
Write-Host "`n=== Phase F1: Unified Geometry Kernel ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase F1 complete [score: 111]" -ForegroundColor Green; exit 0 }
