# verify_R5.ps1 — Phase R5: Combo System
...
$modules = @(
    "titan/omnirouter/r5_combo.ti",
    "tests/test_r5.ti"
)
$regression = @(
    "titan/omnirouter/r4_mcp.ti",
    "titan/omnirouter/r3_fallback.ti"
)
$failed = 0
Write-Host "`n=== Phase R5: Combo System ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) {
    Write-Host "RESULT: ALL $total VERIFIED — Phase R5 complete [score: 111]" -ForegroundColor Green
    exit 0
} else {
