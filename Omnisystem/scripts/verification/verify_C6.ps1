# verify_C6.ps1 — Phase C6: IDE Integration
...
$modules = @("titan/omnicloak/c6_ide.ti", "tests/test_c6.ti")
$regression = @("titan/omnicloak/c5_ui.ti", "titan/omnicloak/c4_antifp.ti")
$failed = 0
Write-Host "`n=== Phase C6: IDE Integration ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase C6 complete [score: 111]" -ForegroundColor Green; exit 0 }
