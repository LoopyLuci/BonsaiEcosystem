# verify_F15.ps1 — Phase F15: Benchmarking & Optimization
...
$modules = @("titan/omnidesign/f15_bench.ti", "tests/test_f15.ti")
$regression = @("titan/omnidesign/f14_verify.ti", "titan/omnidesign/f13_asset.ti")
$failed = 0
Write-Host "`n=== Phase F15: Benchmarking & Optimization ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase F15 complete [score: 111]" -ForegroundColor Green; exit 0 }
