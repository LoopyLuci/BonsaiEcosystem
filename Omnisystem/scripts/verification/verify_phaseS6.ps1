# verify_phaseS6.ps1 — Phase S6: OmniSplat: Edit History & Undo/Redo
...
$failed = 0
Write-Host "`n=== Phase S6: OmniSplat: Edit History & Undo/Redo ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) {
    Write-Host "RESULT: ALL $total VERIFIED — Phase S6 complete [score: 111]" -ForegroundColor Green
    exit 0
} else {
