# verify_F2.ps1 — Phase F2: Parametric History Engine
...
$modules = @("titan/omnidesign/f2_history.ti", "tests/test_f2.ti")
$regression = @("titan/omnidesign/f1_kernel.ti", "titan/omnibot/h9_ide.ti")
$failed = 0
Write-Host "`n=== Phase F2: Parametric History Engine ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase F2 complete [score: 111]" -ForegroundColor Green; exit 0 }
