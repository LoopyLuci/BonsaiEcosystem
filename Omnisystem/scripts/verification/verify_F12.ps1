# verify_F12.ps1 — Phase F12: IDE Integration
...
$modules = @("titan/omnidesign/f12_ide.ti", "tests/test_f12.ti")
$regression = @("titan/omnidesign/f11_aipanel.ti", "titan/omnidesign/f10_logic.ti")
$failed = 0
Write-Host "`n=== Phase F12: IDE Integration ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase F12 complete [score: 111]" -ForegroundColor Green; exit 0 }
