# verify_T1.ps1 — Phase T1: Token Importance Scorer
...
$failed = 0
Write-Host "`n=== Phase T1: Token Importance Scorer ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) {
    Write-Host "RESULT: ALL $total VERIFIED — Phase T1 complete [score: 111]" -ForegroundColor Green
    exit 0
} else {
