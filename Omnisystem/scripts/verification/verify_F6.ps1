# verify_F6.ps1 — Phase F6: Animation System
...
$modules = @("titan/omnidesign/f6_anim.ti", "tests/test_f6.ti")
$regression = @("titan/omnidesign/f5_physics.ti", "titan/omnidesign/f4_render.ti")
$failed = 0
Write-Host "`n=== Phase F6: Animation System ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase F6 complete [score: 111]" -ForegroundColor Green; exit 0 }
