# verify_C1.ps1 — Phase C1: Secure Circuit Builder
...
$modules = @("titan/omnicloak/c1_circuit.ti", "tests/test_c1.ti")
$regression = @("titan/omnirouter/r9_agent.ti", "titan/omnirouter/r8_verify.ti")
$failed = 0
Write-Host "`n=== Phase C1: Secure Circuit Builder ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase C1 complete [score: 111]" -ForegroundColor Green; exit 0 }
