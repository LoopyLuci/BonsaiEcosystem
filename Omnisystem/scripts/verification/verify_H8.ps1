# verify_H8.ps1 — Phase H8: Axiom Verification
...
$modules = @("titan/omnibot/h8_verify.ti", "tests/test_h8.ti")
$regression = @("titan/omnibot/h7_learn.ti", "titan/omnibot/h6_chat.ti")
$failed = 0
Write-Host "`n=== Phase H8: Axiom Verification ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase H8 complete [score: 111]" -ForegroundColor Green; exit 0 }
