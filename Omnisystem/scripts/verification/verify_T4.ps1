# verify_T4.ps1 — Phase T4: KV Cache Manager
...
$failed = 0
Write-Host "`n=== Phase T4: KV Cache Manager ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) {
    Write-Host "RESULT: ALL $total VERIFIED — Phase T4 complete [score: 111]" -ForegroundColor Green
    exit 0
} else {
