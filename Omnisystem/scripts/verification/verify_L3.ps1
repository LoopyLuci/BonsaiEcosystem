# verify_L3.ps1 — Phase L3: Image & Media Codecs
...
$modules = @("titan/omnilib/l3_media.ti", "tests/test_l3.ti")
$regression = @("titan/omnilib/l2_db.ti", "titan/omnilib/l1_net.ti")
$failed = 0
Write-Host "`n=== Phase L3: Image & Media Codecs ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase L3 complete [score: 111]" -ForegroundColor Green; exit 0 }
