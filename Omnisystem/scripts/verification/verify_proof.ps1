# verify_proof.ps1 — Proof Explorer lens + config change manager + regression
...
Write-Host "`n=== Proof Explorer + Config Change ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) {
    Write-Host "RESULT: ALL $total VERIFIED — Proof OK [score: 111]" -ForegroundColor Green
    exit 0
} else {
