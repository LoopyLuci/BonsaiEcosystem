# verify_H5.ps1 — Phase H5: Native Tools
...
$modules = @("titan/omnibot/h5_tools.ti", "tests/test_h5.ti")
$regression = @("titan/omnibot/h4_router.ti", "titan/omnibot/h3_integ.ti")
$failed = 0
Write-Host "`n=== Phase H5: Native Tools ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase H5 complete [score: 111]" -ForegroundColor Green; exit 0 }
