# verify_F13.ps1 — Phase F13: Asset Pipeline
...
$modules = @("titan/omnidesign/f13_asset.ti", "tests/test_f13.ti")
$regression = @("titan/omnidesign/f12_ide.ti", "titan/omnidesign/f11_aipanel.ti")
$failed = 0
Write-Host "`n=== Phase F13: Asset Pipeline ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) { Write-Host "RESULT: ALL $total VERIFIED — Phase F13 complete [score: 111]" -ForegroundColor Green; exit 0 }
