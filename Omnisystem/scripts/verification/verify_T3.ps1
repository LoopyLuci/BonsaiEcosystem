# verify_T3.ps1 — Phase T3: Abstractive Compressor
...
$failed = 0
Write-Host "`n=== Phase T3: Abstractive Compressor ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) {
    Write-Host "RESULT: ALL $total VERIFIED — Phase T3 complete [score: 111]" -ForegroundColor Green
    exit 0
} else {
