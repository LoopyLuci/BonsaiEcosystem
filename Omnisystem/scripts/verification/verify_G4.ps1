# verify_G4.ps1 — Phase G4: Visualisation Framework
...
$failed = 0
Write-Host "`n=== Phase G4: Visualisation Framework ===" -ForegroundColor Cyan
...
Write-Host ""
if ($failed -eq 0) {
    Write-Host "RESULT: ALL $total VERIFIED — Phase G4 complete [score: 111]" -ForegroundColor Green
    exit 0
} else {
