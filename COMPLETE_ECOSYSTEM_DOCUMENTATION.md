...
1. **USOS** — The operating system foundation
...
## 🖥️ Section 1: USOS — The Foundation

### What is USOS?

**USOS** = Unified Secure Operating System.

It is the foundation. Every other part of Bonsai runs on USOS. But USOS itself can run in three ways:

| Mode | What it means | When to use |
|------|---------------|------------|
| **Application mode** | Runs as a program inside Windows, macOS, or Linux | Right now — try Bonsai without changing your OS |
| **Integrated mode** | Runs as a lightweight VM alongside your existing OS | When you want USOS features without full commitment |
| **Standalone mode** | Boots directly on your hardware as the only OS | For maximum security and performance |

### The USOS Stack (from bottom to top)
...
**Example:**
```
Your USOS system has 3 vaults running right now:
...
2. USOS builds a new Crystal from the Blueprint
3. The system switches to the new Crystal instantly
4. If the new Crystal fails, USOS automatically switches back
...
**Example:**
```
Your home network has 3 USOS devices:
...
TransferDaemon handles all network connections for USOS. It:
...
Nexus is a **private blockchain** built into USOS. It powers:
...
| **Sentinel Core** | Microkernel at the heart of USOS |
...
1. Read: **Section 1 (USOS)** — understand the foundation
...
1. Read: **Section 1 (USOS)** and **Section 4 (BCF, Octopus AI)**
...
A: USOS core: 500 MB. BonsAI V2: 4-40 GB depending on model size. Plus your data.
