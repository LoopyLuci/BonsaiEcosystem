...
>
> 1. **Analyze** `crates/bonsai-mcp-server/src/tools.rs` and identify 3 new tools that would be useful.
...
| Terminal | Command |
|----------|---------|
| **T1** | `cargo run -p bonsai-mcp-server -- visual --hitl-categories destructive,network --port 11426` |
