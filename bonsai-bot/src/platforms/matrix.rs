        ...
        client.add_event_handler(move |ev: OriginalSyncRoomMessageEvent, room: Room| {
            ...
            async move {
                ...
                if !cfg.allowed_rooms.is_empty() {
                    ...
                    if !cfg.allowed_rooms.contains(&room_id) {
                        return;
                    }
                }
