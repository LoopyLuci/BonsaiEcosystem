...
1. **`crates/bonsai-mcp-server/src/bug_hunt_tools.rs`** (280 LOC)
...
2. **`crates/bonsai-mcp-server/src/lint_tools.rs`** (240 LOC)
...
3. **`crates/bonsai-mcp-server/src/tool_registry.rs`** (350 LOC)
...
Edit `crates/bonsai-mcp-server/src/lib.rs` (or `main.rs`) and add:
...
- [ ] Code compiles: `cargo build --package bonsai-mcp-server`
- [ ] MCP server starts: `cargo run --package bonsai-mcp-server`
...
- **Bug Hunt Tools:** `crates/bonsai-mcp-server/src/bug_hunt_tools.rs`
- **Lint Tools:** `crates/bonsai-mcp-server/src/lint_tools.rs`
- **Registry:** `crates/bonsai-mcp-server/src/tool_registry.rs`
...
1. ✅ Integrate the three new files into bonsai-mcp-server
...
All code provided. Ready to be added to bonsai-mcp-server crate.
