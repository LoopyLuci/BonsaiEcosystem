...
**File:** `crates/bonsai-mcp-server/src/bug_hunt_tools.rs`
...
**File:** `crates/bonsai-mcp-server/src/lint_tools.rs`
...
**File:** `crates/bonsai-mcp-server/src/tool_registry.rs`
...
**File:** `crates/bonsai-mcp-server/src/lib.rs`
...
**File:** `crates/bonsai-mcp-server/src/server.rs` (or similar)
...
1. Copy the three files to `crates/bonsai-mcp-server/src/`
