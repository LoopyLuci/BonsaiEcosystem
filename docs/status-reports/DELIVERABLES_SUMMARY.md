...
- **Location:** `crates/mcp-server/src/bug_hunt_tools.rs`
- **7 async handlers:**
...
- **Location:** `crates/mcp-server/src/lint_tools.rs`
- **8 async handlers:**
...
- **Location:** `crates/mcp-server/src/tool_registry.rs`
...
2. Run `setup-bug-hunter.ps1 -BuildOnly`
3. Start server: `.\target\release\mcp-server.exe`
