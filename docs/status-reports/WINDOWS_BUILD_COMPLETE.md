...
|-----------|------|--------|
| **UOSC Kernel** | `crates/UOSC-kernel/` | ✅ Source ready |
...
```powershell
cd crates\UOSC-kernel
cargo build --release --target x86_64-unknown-none
# Output: target/x86_64-unknown-none/release/UOSC-kernel
```
...
│   │   └── target/x86_64-unknown-none/release/UOSC-kernel
│   ├── octopus-ai/
