...
**Location**: `crates/mcp-server/src/mobile_session.rs` (280 lines)
...
**Location**: `crates/mcp-server/src/uacs.rs` (added 100+ lines)
...
**Location**: `crates/mcp-server/src/bti_commands.rs` (270 lines)
