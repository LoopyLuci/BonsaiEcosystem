...
impl LanguageFrontend for MarkupFrontend {
    ...
    fn file_extensions(&self) -> &[&str] { &["markup"] }
    ...
    async fn parse(&self, _source: &str, file_path: &Path) -> bonsai_language_frontend::Result<LairModule> {
        Ok(LairModule {
            ...
            metadata: ModuleMetadata {
                imports: vec![],
                exports: vec![],
                source_language: Some("Markup".into()),
            },
        })
    }
}
