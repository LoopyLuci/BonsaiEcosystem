...
pub fn discover_apps() -> Result<Vec<BonsaiApp>> {
    let mut apps = vec![
        ...
        BonsaiApp {
            id: "octopus-ai".into(),
            name: "Octopus AI".into(),
            description: "Server management intelligence".into(),
            icon: "🐙".into(),
            category: AppCategory::AI,
            executable: find_executable("bonsai-api-gateway"),
            launch_command: Some("bonsai-api-gateway --host 127.0.0.1 --port 11425".into()),
            is_installed: is_installed("bonsai-api-gateway"),
            is_running: is_port_open(11425),
            port: Some(11425),
            version: "1.0.0".into(),
        },
        BonsaiApp {
        ...
        BonsaiApp {
            ...
            executable: find_executable("bonsai-mcp-server"),
            launch_command: Some("bonsai-mcp-server --port 11426".into()),
            is_installed: is_installed("bonsai-mcp-server"),
            is_running: is_port_open(11426),
            port: Some(11426),
            version: "0.1.0".into(),
        },
        BonsaiApp {
            id: "bonsai-omnibot".into(),
            name: "OmniBot".into(),
            description: "Discord & Telegram control".into(),
            icon: "🤖".into(),
            category: AppCategory::Communication,
            executable: find_executable("bonsai-omnibot"),
            launch_command: Some("bonsai-omnibot serve".into()),
            is_installed: is_installed("bonsai-omnibot"),
            is_running: false,
            port: None,
            version: "0.1.0".into(),
        },
