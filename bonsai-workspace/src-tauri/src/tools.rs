...
pub struct ToolDef {
    ...
    pub is_custom: bool,
    /// Optional proof hash for TrustGuard Axiom verification.
    pub proof_hash: Option<String>,
    /// Whether the proof has been verified successfully.
...
pub fn load_custom_tools(workspace_path: &Path) -> Vec<ToolDef> {
    ...
    for entry in entries.flatten() {
        ...
        tools.push(ToolDef {
            ...
            proof_verified: manifest.proof_verified.unwrap_or(false),
